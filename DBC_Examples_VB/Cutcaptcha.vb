...
Public Class Cutcaptcha
    Public Shared Sub Main(ByVal args As String())
        ...
        Dim apikey as String = "SAs61IAI"
        Dim miserykey as String = "56a9e9b989aa8cf99e0cea28d4b4678b84fa7a4e"
        Dim pageurl as String = "https://filecrypt.cc/Contact.html"

        Console.WriteLine(String.Format("Your balance is {0,2:f} US cents",
                                        client.Balance))

        ' Create a JSON with the extra data
        Dim cutcaptchaParams as String = "{""proxy"": """ + proxy + """," +
                             """proxytype"": """ + proxyType + """," +
                             """apikey"": """ + apikey + """," +
                             """miserykey"": """ + miserykey + """," +
                             """pageurl"": """ + pageurl + """}"
        ...
        extraData.Add("type", 19)
        extraData.Add("cutcaptcha_params", cutcaptchaParams)
