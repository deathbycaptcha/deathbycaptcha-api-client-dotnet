...
Public Class Mtcaptcha
    Public Shared Sub Main(ByVal args As String())
        ...
        Dim sitekey as String = "MTPublic-KzqLY1cKH"
        Dim pageurl as String = "https://2captcha.com/demo/mtcaptcha"

        Console.WriteLine(String.Format("Your balance is {0,2:f} US cents",
                                        client.Balance))

        ' Create a JSON with the extra data
        Dim mtcaptchaParams as String = "{""proxy"": """ + proxy + """," +
                             """proxytype"": """ + proxyType + """," +
                             """sitekey"": """ + sitekey + """," +
                             """pageurl"": """ + pageurl + """}"
        ...
        extraData.Add("type", 18)
        extraData.Add("mtcaptcha_params", mtcaptchaParams)

        ' Upload a CAPTCHA and poll for its status.  Put the Mtcaptcha
