...
|---|---|---|---|
| Unit Tests net6 | Unit tests on `net6.0` (without integration category) | ![Unit Tests net6](https://github.com/deathbycaptcha/deathbycaptcha-api-client-dotnet/actions/workflows/unit-tests-net6.yml/badge.svg?branch=main) | [unit-tests-net6.yml](https://github.com/deathbycaptcha/deathbycaptcha-api-client-dotnet/actions/workflows/unit-tests-net6.yml) |
| Unit Tests net8 | Unit tests on `net8.0` (without integration category) | ![Unit Tests net8](https://github.com/deathbycaptcha/deathbycaptcha-api-client-dotnet/actions/workflows/unit-tests-net8.yml/badge.svg?branch=main) | [unit-tests-net8.yml](https://github.com/deathbycaptcha/deathbycaptcha-api-client-dotnet/actions/workflows/unit-tests-net8.yml) |
| Unit Tests net10 | Unit tests on `net10.0` (without integration category) | ![Unit Tests net10](https://github.com/deathbycaptcha/deathbycaptcha-api-client-dotnet/actions/workflows/unit-tests-net10.yml/badge.svg?branch=main) | [unit-tests-net10.yml](https://github.com/deathbycaptcha/deathbycaptcha-api-client-dotnet/actions/workflows/unit-tests-net10.yml) |
| Integration Tests Basic | Basic integration tests on `net10.0` | ![Integration Tests Basic](https://github.com/deathbycaptcha/deathbycaptcha-api-client-dotnet/actions/workflows/integration-basic.yml/badge.svg?branch=main) | [integration-basic.yml](https://github.com/deathbycaptcha/deathbycaptcha-api-client-dotnet/actions/workflows/integration-basic.yml) |
